 ...
 <a href="index.php"><img alt="Brand" src="images/amir.png" width="160" height="54" align="left"></a> 
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
      <ul class="nav navbar-nav">
		...
		<li class="active"><a href="#" class="glyphicon glyphicon-phone-alt"><hnazanins style="color:gray">&nbsp;&nbsp;تماس با ما</hnazanins></a></li>
...
<div class="panel panel-danger" style="position:relative; right:42px; top:20px; width:1250px; height:200px;">
  <!-- Default panel contents -->
  <div class="panel-heading" align="center"><b><hnazanins style="color:blue;">شماره های تماس</hnazanins></b></div>
  <div class="panel-body">
    <p class="glyphicon glyphicon-earphone"><hnazanins style="color:green;">937-3010021</hnazanins></p>
    <br><br><br><p class="glyphicon glyphicon-earphone"><hnazanins style="color:green;">936-0563395</hnazanins></p>
	</div>
</div>
	
<div class="panel panel-danger" style="position:relative; right:42px; top:60px; width:1250px; height:200px;">
  <!-- Default panel contents -->
  <div class="panel-heading" align="center"><b><hnazanins style="color:blue;">آدرس</hnazanins></b></div>
	<div class="panel-body">
	<p class="glyphicon glyphicon-hand-left"><hnazanins style="color:green;">&nbsp;&nbsp;&nbsp;شهرک ژاندارمری</hnazanins></p>
    <br><br><br><p class="glyphicon glyphicon-hand-left"><hnazanins style="color:green;">&nbsp;&nbsp;&nbsp;مینی سیتی</hnazanins></p>	
	</div>
</div>
